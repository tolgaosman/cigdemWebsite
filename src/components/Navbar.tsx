  ...
  return (
    <>
      <nav className={`navbar${scrolled ? ' scrolled' : ''}`}>
        {/* Sol taraftaki sayfa isimleri */}
        <div className="navbar-links desktop-only" style={{ flex: 1, display: 'flex', justifyContent: 'flex-start' }}>
          {links.map((l) => (
        ...
        {/* Sağ taraftaki sosyal ikonlar ve Randevu butonu */}
        <div className="navbar-actions desktop-only" style={{ flex: 1, display: 'flex', justifyContent: 'flex-end', alignItems: 'center', gap: '1.2rem' }}>
          <a href="https://instagram.com" target="_blank" rel="noreferrer" aria-label="Instagram" className="nav-social">
          ...
          <a href="https://linkedin.com" target="_blank" rel="noreferrer" aria-label="LinkedIn" className="nav-social">
          ...
          <a href="https://wa.me/" target="_blank" rel="noreferrer" aria-label="WhatsApp" className="nav-social">
